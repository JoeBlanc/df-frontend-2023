        ...
        <div className="fixed z-[10] top-[40%] left-[50%] -translate-x-1/2 -translate-y-1/2">
          <div className="bg-white shadow-md rounded-lg w-[400px] px-8 pt-6 pb-8 mb-4">
            ...
            <form onSubmit={handleAddBook} className="w-full px-8 py-4 ">
              <div className="mb-4">
                <label className="block text-left text-gray-700 text-md font-bold mb-2" htmlFor='Name'>
                  Name
              ...
              <div className="mb-4">
                <label className="block text-left text-gray-700 text-md font-bold mb-2" htmlFor="author-name">
                  Author
              ...
              <div className="mb-6">
                <label className="block text-left text-gray-700 text-md font-bold mb-2" htmlFor="book-topic">
                  Topic
